// Felix Bot v9.0 - Local Polling Mode (без ngrok)
// Запуск: node bot-local-polling.js

const TOKEN = '8623255560:AAE7sC-7-eWA5LD-ebATDUh6nGUG0pYm03U';
const TELEGRAM_API = `https://api.telegram.org/bot${TOKEN}`;
const MINIAPP_URL = 'https://felix2-0.vercel.app/miniapp/index.html'; // Академия
...
async function handleMessage(message) {
  ...
  if (text.startsWith('/')) {
    ...
    switch (cmd) {
      case 'start':
        await send(chatId, `🌟 <b>Felix v9.0 - Local Test</b>
...
Или просто напиши мне что-нибудь, и я отвечу через AI! 🚀`);
      ...
      case 'help':
        await send(chatId, `📖 <b>Команды Felix v9.0</b>
